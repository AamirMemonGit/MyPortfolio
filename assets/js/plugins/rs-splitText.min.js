        ...
        ((v = (c = y[e]).parentNode === d) || o || (x && !r)) &&
          ...
          u &&
            (((c._isSplit && v) ||
              ...
              (w.push(c), (c._x -= K), l(c, d, F) && (c._wordEnd = !0)),
            "BR" === c.nodeName &&
              ((c.nextSibling && "BR" === c.nextSibling.nodeName) || 0 === e) &&
              u.push([])));
    for (e = 0; e < t; e++)
      if (((v = (c = y[e]).parentNode === d), "BR" !== c.nodeName))
        if (
          (o &&
            ((q = c.style),
            r || v || ((c._x += c.parentNode._x), (c._y += c.parentNode._y)),
            (q.left = c._x + "px"),
            (q.top = c._y + "px"),
            (q.position = "absolute"),
            (q.display = "block"),
          ...
          if (c._isSplit)
            for (
              c._next = j = c.nextSibling, c.parentNode.appendChild(c);
        ...
        u || o
          ? (c.parentNode && c.parentNode.removeChild(c), y.splice(e--, 1), t--)
          : r || d.appendChild(c);
      ...
      for (J = " " === F && (!o || (!r && !x)), e = 0; e < u.length; e++) {
        for (
          ...
          "BR" !== w[j].nodeName &&
            ...
            o &&
              (0 === j &&
                ((f.style.top = c._y + "px"), (f.style.left = K + p + "px")),
              (c.style.top = "0px"),
      ...
      if (((d = c.charAt(a)), A && (w = A(c.substr(a), e.specialChars))))
        ...
        "{" === d && "{{LT}}" === c.substr(a, 6)
          ...
          : (55296 <= d.charCodeAt(0) && d.charCodeAt(0) <= 56319) ||
            (65024 <= c.charCodeAt(a + 1) && c.charCodeAt(a + 1) <= 65039)
          ? ((m = ((c.substr(a, 12).split(s) || [])[1] || "").length || 2),
            (f +=
              n && " " !== d
                ? o() + c.substr(a, m) + "</" + j + ">"
                : c.substr(a, m)),
